...
- If the method is an overloaded operator, the name will be the word "operator"
  followed by the operator without leaving any spaces in between. For example "operator+=".
...
- In some parameters of some of these checks, it is allowed to introduce "?"
  ...
  all the methods with the same name in the indicated class (regardless of their parameters).

  In the descriptions of the checks in this file, this property is indicated with (?).

  Note: In the case of setting "?" as argument of a parameter to indicate the list of
        parameters of a method, the check will not take into account the
        parameter list. We have to distinguish between this case and the situation of a
        method without parameters; that case is indicated with an empty list {}.
...
- Parameters:
---vector<string> className (*): vector of strings with the name of the classes to be searched.
...
- Utility: Method to check the existence of a class. Unlike the check "findClass", this
           check is executed when the method "check" is invoked.
...
- Parameters:
---string className (*): string with the name of the class to be searched.
---vector<string> memberName (*): vector of strings with the names of the members to which the delete operator is applied.
...
- Parameters:
---string className (*): string with the name of the class to be searched.
---unsigned int constructors: integer with the number of consrtuctor of the class.
---lenient: boolean indicating whether it is allowed a number of constructors equal or greater (true) or only an equal number of constructors (false). By default it is set to "false".
...
- Parameters:
---string methodName (*): string with the name of the method that should use the dynamic cast.
---vector<string> parameters: vector of strings with the parameters of the method to be searched.
...
- Example:
	...
	methodWithDynamicCast("method",{"class myType2 *","class myType3 *"},"A","noconst","class myType2 *", "class myType1 *");	Pass
	methodWithDynamicCast("method",{"class myType2 *","class myType3 *"},"A","noconst","class myType3 *", "class myType1 *");	Pass
	methodWithDynamicCast("method",{"class myType2 *","class myType3 *"},"A","noconst","class myType1 *", "class myType1 *");	Fail
...
- Parameters:
---string className (*): string with the name of the class to be searched.
---vector<string> variableNames (*): vector of strings with the names of the static variables to be searched.
---vector<string> constant (?): vector of strings indicating whether the variables are constant or not.
- Example:
...
Parameters:
---string className (*): string with the name of the class to be searched.
---vector<string> memberName (*): vector of strings with the names of attributes to be searched.
...
- Parameters:
---vector<string> methodNames (*): vector of strings with the names of the methods to be searched.
---vector<vector<string> > parameters (?): vector of vector of strings with the types of the method parameters to be searched.
...
- Parameters:
---vector<string> methodNames (*): vector of strings with the names of the methods to be searched.
---vector<vector<string> > parameters (?): vector of vector of strings with the types of the parameters of the methods to be searched.
---string className (*): string with the name of the class where the methods have to be searched.
---vector<string> constant (?): vector of strings indicating whether the methods are constant or not.
---vector<string> usedVariables: vector of strings with the names of the attributes that are referenced by the methods.
...
- Example:
	...
	methodWithReferencedMemberVariable({"method1"}, {{"?"}}, "A", {"?"}, {"a"}); Pass
...
- Parameters:
---vector<string> mainMethodNames (*): vector of strings with the names of the main methods to be searched.
---vector<vector<string> > mainMethodparameters (?): vector of vector of strings with the types of the parameters of the main methods.
---string mainClassName (*): string with the name of the class where the main methods have to be searched.
---vector<string> mainConstant (?): vector of strings indicating whether the main methods are constant or not.
---vector<string> usedMethodNames (*): vector of strings with the name of the methods to be searched that are referenced by the main methods.
---vector<vector<string> > usedMethodparameters (?): vector of vector of strings with the types of the parameters of the referenced methods.
---string usedClassName (*): string with the name of the class where the referenced methods have to be searched.
---vector<string> usedConstant (?): vector of strings indicating whether the referenced methods are constant or not.
...
- Example:
	...
	methodWithReferencedMethod({"method1"}, {{"?"}}, "A", {"?"}, {"method3"}, {{"?"}}, "A", {"?"}); Pass
...
- Parameters:
---vector<string> methodNames (*): vector of strings with the names of the methods to be searched.
---vector<string> parameters (?): vector of vector of strings with the types of the parameters of the methods to be searched.
---string className (*): string with the name of the class where the methods have to be searched.
---vector<string> constant (?): vector of strings indicating whether the methods are constant or not.
...
- Parameters:
---vector<string> methodNames (*): vector of strings with the name of the methods to be searched.
---vector<string> parameters (?): vector of vector of strings with the types of the parameters of the methods to be searched.
---string className (*): string with the name of the class where the methods have to be searched.
---vector<string> constant (?): vector of strings indicating whether the methods are constant or not.
...
- Parameters:
---vector<string> functionNames (*): vector of strings with the name of the functions to be searched.
---vector<vector<string> > parameters (?): vector of vector of strings with the types of the parameters of the functions to be searched.
...
- Parameters:
---vector<string> mainMethodNames (*): vector of strings with the names of the main methods to be searched.
---vector<vector<string> > mainMethodparameters (?): vector of vector of strings with the names of the types of the parameters with the main methods to be searched.
---string mainClassName (*): string with the name of the class where the main methods have to be searched.
---vector<string> mainConstant (?): vector of strings indicating whether the main methods are constant or not.
---vector<string> usedFunctionNames (*): vector of strings with the names of the functions to be searched that are referenced by the main functions.
---vector<vector<string> > usedFunctionParameters (?): vector of vector strings with the types of the parameters of the referenced functions.
...
- Example:
	...
	methodWithReferencedFunction({"method1"}, {{"?"}}, "A", {"?"}, {"function1"}, {{"?"}}); Pass
	methodWithReferencedFunction({"method1"}, {{"?"}}, "A", {"?"}, {"function2"}, {{"?"}}); Fail
...
- Parameters:
---vector<string> mainFunctionNames (*): vector of strings with the names of the main functions to be searched.
---vector<vector<string> > mainFunctionParameters (?): vector of vector of strings with the types of the parameters of the main functions to be searched.
---vector<string> usedMethodNames (*): vector of strings with the name of the method to be searched that are referenced by the main method.
---vector<vector<string> > usedMethodparameters (?): vector of vector of strings with the types of the parameters of the referenced methods to be searched.
---string usedClassName (*): string with the name of the class where the referenced methods have to be searched.
---vector<string> usedConstant (?): vector of strings indicating whether the referenced methods are constant or not.
...
- Example:
	...
	functionWithReferencedMethod({"function1"}, {{"?"}}, {"method1"}, {{"?"}}, "A", {"?"}); Pass
	functionWithReferencedMethod({"function1"}, {{"?"}}, {"method2"}, {{"?"}}, "A", {"?"}); Fail
...
---vector<vector<string> > mainFunctionParameters (?): vector of vector of strings with the types of the parameters of the main functions to be searched.
---vector<string> usedFunctionNames (*): vector of strings with the names of the functions to be searched that are referenced by the main functions.
---vector<vector<string> > usedFunctionParameters (?): vector of vector of strings with the types of the parameters of the referenced functions to be searched.
...
- Example:
	...
	functionWithReferencedFunction({"function1"}, {{"?"}}, {"function3"}, {{"?"}}); Pass
	functionWithReferencedFunction({"function2"}, {{"?"}}, {"function3"}, {{"?"}}); Fail
...
---bool exist: boolean indicating that the functions should be taken from the header (true) or not (false).
...
---vector<string> fileNames: vector of strings with the name of the files where the header has to be searched.
...
- Parameters:
---string fileName: string with the name of the file where the guard clause has to be searched.
...
- Parameters:
---vector<string> functionNames (*): vector of strings with the names of the functions to be searched.
---vector<vector<string> > parameters (?): vector of vector of strings with the types of the parameters of the functions to be searched.
---string className (*): string with the name of the class where the desired functions have to be searched.
...
- Parameters:
---string className (*): string with the name of the class where the friend classes has to be searched.
---vector<string> friendClassesNames (*): vector of strings with the names of the friend classes to be searched.
